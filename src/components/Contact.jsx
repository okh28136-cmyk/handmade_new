...
const Contact = () => {
  ...
  return (
    <section className="contact" id="contact">
      <div className="container" style={{ transition: 'all 0.3s ease', maxWidth: calcStep === 3 ? '1300px' : '1200px' }}>
        <div className="contact-wrapper" style={{ transition: 'all 0.3s ease', gap: calcStep === 3 ? '40px' : '80px' }}>
          
          {/* 좌측 안내 문구 영역 (Step 1, 2에서만 표시) */}
          {calcStep !== 3 && (
            <div className="contact-info animate-fade-in" style={{ flex: 1 }}>
          ...
          {/* 우측 견적 문의 영역 (계산기 임베딩) */}
          <div className="contact-form-container" style={{ transition: 'all 0.3s ease', flex: calcStep === 3 ? '1 1 100%' : '1' }}>
