...
const Calculator = ({ onStepChange }) => {
  ...
  return (
    <div className="calculator-container" style={{ width: '100%', background: 'var(--bg-color)', color: 'var(--text-main)' }}>
      ...
      {activeModal && (
        <div className="desktop-modal animate-fade-in" style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(15, 23, 42, 0.4)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '1rem' }}>
